...
public class Form {
    ...
    public Form(String name, String birthday, String gender, String country, String idCard, String transferBy,
                String vehicleNumber, String seatNumber, String departAt, String arriveBy, String whereToGoIn14Days,
                String province, String district, String ward, String houseNumber, String phone, String email,
                Boolean fever, Boolean cough, Boolean difficultyOfBreathing, Boolean soreThroat, Boolean vomiting,
                Boolean diarrhea, Boolean skinHaemorrhage, Boolean rash, Boolean visitAny, Boolean careFor) {
        this.name = name;
